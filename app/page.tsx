...
export default function Home() {
  return <div className="pawstory-home">
    ...
    <section className="promo-film"><div><span className="eyebrow">THE PAWSTORY FILM</span><h2>一场奇遇，<br />从它开始。</h2><p>让照片成为作品，让小小配件装下故事。<br />看一看，陪伴如何拥有形状。</p><span className="film-credit">PawStory 宣传短片</span></div><video controls playsInline preload="metadata" aria-label="PawStory 项目宣传视频"><source src="/showcase/pawstory-promo-21b7f797.mp4" type="video/mp4" />你的浏览器暂不支持视频播放。</video></section>
